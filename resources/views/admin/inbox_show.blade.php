    ...
    <div class="col-9">
      <div class="card card-cyan card-outline">
        ...
        <div class="card-header">
          ...
          <div class="card-tools">
            <a href="{{$previous ? route('inbox.show',$previous) : ''}}" class="btn btn-tool text-info{{$previous ? '' : ' disabled invisible'}}" data-toggle="tooltip" title="Previous"><i class="fas fa-chevron-left"></i></a>
            <a href="{{$next ? route('inbox.show',$next) : ''}}" class="btn btn-tool text-info{{$next ? '' : ' disabled invisible'}}" data-toggle="tooltip" title="Next"><i class="fas fa-chevron-right"></i></a>
          </div>
        </div>
